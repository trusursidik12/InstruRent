          ...
          <div class="row">
            <div class="site-title-bar" data-responsive-toggle="mobile-menu" data-hide-for="large">
              <div class="title-bar-left">
                ...
                <span class="site-mobile-title title-bar-title logo"> <a href="<?= base_url(); ?>" rel="home" title="Backhoe &#8211; Heavy &amp; Construction Equipment Rentals &amp; Machinery WordPress Theme" class="active"><img src="<?= base_url(); ?>/assets/dist/images/instrurent_logo.png" /></a>
                </span>
              </div>
              ...
              <div class="top-bar-left">
                <div class="site-desktop-title top-bar-title">
                  <div class="logo-wrapper " data-dropdown-menu>
                    <a href="<?= base_url(); ?>" rel="home" title="Backhoe &#8211; Heavy &amp; Construction Equipment Rentals &amp; Machinery WordPress Theme" class="active"><img src="<?= base_url(); ?>/assets/dist/images/instrurent_logo.png" /></a>
                  </div>
                </div>
              </div>
