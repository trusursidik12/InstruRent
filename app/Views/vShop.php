        ...
        <div class="woocommerce">
            <ul class="products columns-3 list ">
                <?php foreach ($products as $key => $product) : ?>
                    <li class="product type-produc status-publish instock">
                        <div class='product-image-wrapper'><a href="<?= base_url(); ?>/product/<?= $product["url"]; ?>/"><img width="700" height="700" src="<?= base_url(); ?>/assets/dist/<?= $product["image"]; ?>" class="attachment-woocommerce_thumbnail size-woocommerce_thumbnail" /></a></div>
                        <div class="product-details-wrapper">
                            ...
                            <a href="?add-to-cart=3994" data-quantity="1" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Add to cart</a>
                        </div>
                    </li>
                <?php endforeach; ?>
            </ul>
